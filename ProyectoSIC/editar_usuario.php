    ...
    <div class="row">
      ...
      <div class="col-6">
        ...
        <main class="form-signin w-100 m-auto">
          <form action="editar_usuarioD.php" method="POST">
            <center>
              <h1 class="h3 mb-3 fw-normal">Modificacion de datos del docente</h1>
              ...
              <?php } ?>
              <h5>Para modificar a un usuario es importante escribir el ID</h5>
            </center>
            <div class="form-floating">
              <input type="text" name="idDocente" class="form-control" id="floatingInput" placeholder="ID">
            ...
            <button class="btn btn-warning w-100 py-2" type="submit">Modificar</button>
          </form>
          <!--Fin de formulario-->
          <br>
          <br>
