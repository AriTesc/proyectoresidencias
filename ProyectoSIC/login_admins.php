  ...
  <main class="form-signin w-100 m-auto">
    <form action="inicio_sesion.php" method="POST">
      <center>
        ...
        <h1 class="h3 mb-3 fw-normal">Sesión Administradores</h1>
        <?php
            if (isset($_GET['error'])){
          ?>
        <p class="error">
      ...
      <div class="form-floating">
        <input type="email" name="Email" class="form-control" id="floatingInput" placeholder="usuario">
      ...
      <!--<br><br>
      <center><a href="recuperar_contrasenia.php">¿Olvidaste tu contraseña?</a></center>-->
    </form>
  </main>
  <!--Fin de formulario-->
</body>
