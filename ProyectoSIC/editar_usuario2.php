    ...
    <div class="row">
      ...
      <div class="col-6">
        ...
        <main class="form-signin w-100 m-auto">
          <form action="editar_usuarioA.php" method="POST">
            <center>
              <h1 class="h3 mb-3 fw-normal">Modificacion de datos del alumno</h1>
            ...
            <div class="form-floating">
              <input type="text" name="idAlumno" class="form-control" id="floatingInput" placeholder="ID">
