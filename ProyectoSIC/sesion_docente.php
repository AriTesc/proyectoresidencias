...
<body>
  <div class="container">
    <div class="row">
            ...
            <ul class="list-unstyled ps-0">
              <li class="mb-1">
                ...
                <div class="collapse" id="home-collapse">
                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="crear_form.php" class="link-body-emphasis d-inline-flex text-decoration-none rounded">Registrar formulario</a></li>
                    <li><a href="admin_form.php" class="link-body-emphasis d-inline-flex text-decoration-none rounded">Administrar formularios</a></li>
              ...
              <li class="mb-1">
                ...
                <div class="collapse" id="dashboard-collapse">
                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded">General</a></li>
                    <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded">???</a></li>
                    <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded">???</a></li>
                    <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded">???</a></li>
                  </ul>
              ...
              <li class="mb-1">
                ...
                <div class="collapse" id="account-collapse">
                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded">Rubricas</a>
                    </li>
      ...
      <div class="col-6">
        <!--Inicio de contenido-->
        <p class="top-0 start-50 translate-middle-x">
          Inició sesión de: <?php echo $_SESSION['Nombre_Completo']; ?>
        </p>
        <!--Fin de contenido-->
      </div>
    </div>
