    ...
    <main class="form-signin w-100 m-auto">
      <form action="inicio_sesion_alu.php" method="POST">
        ...
        <div class="form-floating">
          <input type="text" name="a_Usuario" class="form-control" id="floatingInput" placeholder="usuario">
          <label for="floatingInput">Usuario</label>
        </div>
        <div class="form-floating">
          <input type="password" name="a_Contrasenia" class="form-control" id="floatingPassword" placeholder="contra">
